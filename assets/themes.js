...
function _classCallCheck(e, t) {
    ...
    var n = i(8),
        ...
        o = function() {
            ...
            return _createClass(e, [{
                ...
                key: "_attachListeners",
                value: function() {
                    this._onProductAddedListener = this._onProductAdded.bind(this), this.delegateElement.on("change", "#cart-note", this._updateCartNote.bind(this)), "page" !== this.options.type ? (this.delegateElement.on("click", '[data-action="update-item-quantity"], [data-action="remove-item"]', this._updateItemQuantity.bind(this)), this.delegateElement.on("change", ".QuantitySelector__CurrentQuantity", this._updateItemQuantity.bind(this)), this.delegateElement.on("click", '[data-action="add-upsell-item"]', this._addUpsellItem.bind(this))) : this.delegateElement.on("change", ".QuantitySelector__CurrentQuantity", this._reloadPageWithQuantity.bind(this)), this.options.drawer && this.delegateElement.on("click", '[data-action="toggle-cart-note"]', this._toggleCartNote.bind(this)), document.addEventListener("product:added", this._onProductAddedListener), this.documentDelegate.on("cart:refresh", this._rerenderCart.bind(this, !1))
                }
            }, {
                key: "_addUpsellItem",
                value: function(e) {
                    ...
                    e.preventDefault();
                    const i = e.target,
                        n = i.closest(".UpsellItem"),
                        s = JSON.parse(n.querySelector("[data-upsell-variant-json]").innerHTML);
                    i.setAttribute("disabled", "disabled"), document.dispatchEvent(new CustomEvent("theme:loading:start")), fetch(window.routes.cartAddUrl + ".js", {
                        body: JSON.stringify({
                            id: s.id,
                            quantity: 1
                        }),
    ...
    var n = i(21),
        ...
        a = i(56);
    ! function() {
        window.debugRequires = i, console.log("components", i(21)), console.log("helper", i(7)), console.log("sections", i(56)), new n.Collapsible, new n.Modal, new s.ResponsiveHelper, "password" !== window.theme.pageType && "gift_card" !== window.theme.pageType && new n.LoadingBar;
        var e, t, o, r, l, c, d = new a.SectionContainer;
        d.register("header", a.HeaderSection), d.register("footer", a.FooterSection), d.register("sidebar-menu", a.SidebarMenuSection), d.register("cart", a.CartSection), d.register("newsletter-popup", a.NewsletterPopupSection), d.register("slideshow", a.SlideshowSection), d.register("collection-list", a.CollectionListSection), d.register("article-list", a.ArticleListSection), d.register("featured-product", a.FeaturedProductSection), d.register("image-with-text-block", a.ImageWithTextBlockSection), d.register("timeline", a.TimelineSection), d.register("map", a.MapSection), d.register("featured-collections", a.FeaturedCollectionsSection), d.register("shop-the-look", a.ShopTheLookSection), d.register("testimonials", a.TestimonialsSection), d.register("background-video", a.BackgroundVideoSection), d.register("product", a.ProductSection), d.register("product-recommendations", a.ProductRecommendationsSection), d.register("collection", a.CollectionSection), d.register("article-list", a.ArticleListSection), d.register("article", a.ArticleSection), d.register("faq", a.FaqSection), d.register("login", a.LoginSection), d.register("addresses", a.AddressesSection), d.register("gift-card", a.GiftCardSection), d.register("search", a.SearchSection), d.register("recently-viewed-products", a.RecentlyViewedProductsSection), d.register("shop-now", a.ShopNowSection), e = !1, t = void 0, document.body.addEventListener("touchstart", function(i) {
            ...
            }), l = window.innerWidth, c = document.getElementById("shopify-section-header"), window.addEventListener("resize", function() {
                var e = -1;
                fastdom.measure(function() {
                    e = window.innerWidth
                }), fastdom.mutate(function() {
